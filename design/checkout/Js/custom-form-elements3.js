...
var Custom3 = {
	init: function() {
		...
		for(a = 0; a < inputs.length; a++) {
			if((inputs[a].type == "checkbox" || inputs[a].type == "radio") && inputs[a].className == "styled3") {
	...
	clear: function() {
		...
		for(var b = 0; b < inputs.length; b++) {
			if(inputs[b].type == "checkbox" && inputs[b].checked == true && inputs[b].className == "styled3") {
				inputs[b].previousSibling.style.backgroundPosition = "0 -" + checkboxHeight2*2 + "px";
			} else if(inputs[b].type == "checkbox" && inputs[b].className == "styled3") {
				inputs[b].previousSibling.style.backgroundPosition = "0 0";
			} else if(inputs[b].type == "radio" && inputs[b].checked == true && inputs[b].className == "styled3") {
				inputs[b].previousSibling.style.backgroundPosition = "0 -" + radioHeight3*2 + "px";
			} else if(inputs[b].type == "radio" && inputs[b].className == "styled3") {
				inputs[b].previousSibling.style.backgroundPosition = "0 0";
			}
		}
	},
