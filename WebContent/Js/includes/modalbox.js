...
Modalbox.Methods = {
		...
		if(this.event("beforeLoad") != false) { // If callback passed false, skip loading of the content
			if(typeof this.content == 'string') {
				...
				if(htmlRegExp.test(this.content)) { // Plain HTML given as a parameter
					...
					new Ajax.Request( this.content+'&rnd=' + Math.random() * 99999, { method: this.options.method.toLowerCase(), parameters: this.options.params,
	...
	_setWidth: function () { //Set size
        ...
        $(this.MBwindow).setStyle({width: 1214 + "px", height: 750 + "px"});
	},
...
//		$(this.MBwindow).setStyle({width: this.options.width + "px"});
        $(this.MBwindow).setStyle({width: 1214 + "px"});
		this._setPosition();
	},
