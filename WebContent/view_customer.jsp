...
<%
    ...
    String dt = StringUtils.defaultString(request.getParameter("dt"), ActionUtil.EMPTY);
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <form action="./view_customer.jsp" method="post" name="list_form" id="list_form">
			...
			<tr>
				<td width="100%">
                    ...
                    <div class="padder">
                        ...
                        <div class="heading">
                            <%--<h1>Manage Customer &lt;%&ndash;<a>(<%=count%> records)</a>&ndash;%&gt;</h1>--%>
                            <div class="heading">
                                <div class="floatLeft submitBTN"><input name="back" type="button" class="button_small" value="back" onclick="window.location.href='./schedule.do?&dt=<%=dt%>';"></div> <div style="margin-left: 10px;" class="floatLeft"><h1>Manage Customer <%=cust.getFname() + " " + cust.getLname() + ", Phone: " + cust.getPhone()%></h1>  </div> <div class="clear"></div>
                            </div>
                        </div>
                        ...
                        <tr class="filter">
                            ...
                            <th style="width:80px;text-align:center">
                                Action<%--<a href="#"><IMG onclick="ExportToExel();" height="32" alt="Export to Excel" title="Export to Excel" src="img/exporttoexcel.png" width="32" longDesc="img/exporttoexcel.png"></a> Export--%>
                            </th>
                        </tr>
                            <%--<TR class="filter">--%>
...
//                            if (b) {
                        ...
                        <TR <%--<%if(i%2 != 0) out.print("class=\"alt\"");%>--%>>
                            ...
                            <TD nowrap>
                                <a href="./history_customer.jsp?action=hist&id=<%=cust.getId()%>&dt=<%=dt%>"><IMG title="History" height="16" alt="history" src="images/history.png" width="16" longDesc="images/history.png"></a>
                                <a href="./edit_customer.jsp?action=edit&id=<%=cust.getId()%>&dt=<%=dt%>"><IMG title="Edit" height="16" alt="edit" src="images/edit.png" width="16" longDesc="images/edit.png"></a>
                                <a href="#"><IMG title="Delete" onclick="if (confirm('Are you sure want to delete this?')) window.location.href = './view_customer.jsp?action=delete&id=<%=cust.getId()%>&<%=ActionUtil.PAGE%>=<%=pg_num%>&dt=<%=dt%>'" height="16" alt="delete" src="images/delete.png" width="16" longDesc="images/delete.png"></a>
                            </TD>
                        </TR>
                            <%--<%}}%>--%>
                        </table>
                        ...
                        <%--<div class="pagelinks">--%>
                            <%--&lt;%&ndash;<span class="disabled">« Previous</span> <!-- disabled 'previous' link -->&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<span>1</span>  <!-- current page -->&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<a href="#">2</a> <!-- nth page -->&ndash;%&gt;--%>
