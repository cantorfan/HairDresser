...
<%
    ...
    if (action.equalsIgnoreCase(ActionUtil.ACT_EDIT) && StringUtils.isNotEmpty(id))
        cate = Category.findById(Integer.parseInt(id));
    else
        cate = (Category) request.getAttribute("OBJECT");
    String title = "";
				...
				<td>
                    ...
                    <img class="leftcorner" src="../images/page_left.jpg" alt="">
                        <div class="padder">
                            ...
                            <div class="heading">
                                <h1><%=title%> Category</h1> <!-- note: I would do headings like this: Add location, Editing location "Name" -->
                            </div>
                            <!-- success/error message:
                            <div class="error"><p>Error message</p></div>
                            <div class="success"><p>Success message</p></div>
                            -->
                            <form id="category" name="category" method="post" action="./category.do?action=<%=action%>" onsubmit="javascript: return formvalidate(this);">
                            ...
                            <input name="id" type="hidden" value="<%=(cate!=null?String.valueOf(cate.getId()):"")%>">

                            <%--<div class="field">--%>
                                <%--<label for="name">Name</label>--%>
                                <%--<input id="name" name="name" type="text" maxlength="30" value="<%=(cate!=null?cate.getName():"")%>">--%>
                            <%--</div>--%>
                             <div class="validation"><%=resx.getREQMESSAGE()%></div>
                             <div class="field">
                                <label for="details">Category Name <%=resx.getVALIDATOR()%></label>
                                <input valid="text" id="details" name="details" type="text" value="<%=(cate!=null?cate.getDetails():"")%>">
                            </div>
                                ...
                                <div>
                                    ...
                                    <br/>
                                        <tr>
                                            ...
                                            <td>
                                                <%--<input name="back" type="button" class="button_small" value="back" onclick="window.location.href='./list_category.jsp'">--%>
