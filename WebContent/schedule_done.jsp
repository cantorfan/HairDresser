...
<HTML>
	<HEAD>
        ...
        #fnameautocomplete,#lnameautocomplete,#phoneautocomplete,#cellautocomplete,#emailautocomplete { width:10em; /* set width here */ padding-bottom:2em; }
                            ...
                            <td align="left"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        <td class="STYLE18"><div class="b1"><div id="fnameautocomplete">
                                            <input name="fname" id="fname" class="r" type="text" style="HEIGHT:12px" size="10"><!-- onchange="makeRequest('fname',this);"-->
                            ...
                            <td align="left"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        <td class="STYLE18"><div class="b1"><div id="lnameautocomplete">
                                            <input name="lname" id="lname" class="r" type="text" style="HEIGHT:12px" size="10"><!-- onchange="makeRequest('lname',this);"-->
                            ...
                            <td align="left"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        <td class="STYLE18"><div class="b1"><div id="phoneautocomplete">
                                            <input name="phone" id="phone" type="text" class="r" style="HEIGHT:12px" size="10"><!-- onchange="makeRequest('phone',this);"-->
                            ...
                            <td align="left"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        <td class="STYLE18"><div class="b1"><div id="cellautocomplete">
                                            <input name="cell" id="cell" type="text" class="r" style="HEIGHT:12px" size="10"><!-- onchange="makeRequest('cell',this);"-->
                            ...
                            <td align="left"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        <td class="STYLE4"><div class="b1"><div id="emailautocomplete">
                                            <input name="email" id="email" type="text" class="r" style="HEIGHT:12px" size="10"><!-- onchange="makeRequest('email',this);"-->
                                                ...
                                                <td ><!--height="575"-->
                                                    <table  border="0" align="left" cellpadding="0" cellspacing="0"><!--width="720"-->
                                                        ...
                                                        <tr>
                                                            <td width="20"></td>
                                                            <!--time images-->
                                                            <td width="51" height="<%=60*tmh%>px" background="./images/schdule_16_02.gif"  valign="top"><%=i%></td>
                                                            <!--appointments-->
                                                            <td valign="top">
    ...
    function handleDelete(e){//TODO rightclick
    ...
    YAHOO.example.ACJSArray = new function() {
        ...
        this.oAutoComp.textboxFocusEvent.subscribe(function(){
            ...
            if(sInputValue.length == 3) {
                var oSelf = this;
                setTimeout(function(){oSelf.sendQuery(sInputValue);},3);
            }
        });
        this.oAutoComp.textboxBlurEvent.subscribe(function(){
            if(YAHOO.util.Dom.get('fname').value != "")
            makeRequest('fname', document.getElementById('fname'));
        });
        // Instantiate first JS Array DataSource
        ...
        this.oAutoComp1.textboxBlurEvent.subscribe(function(){
            if(YAHOO.util.Dom.get('lname').value != "")
            makeRequest('lname', document.getElementById('lname'));
        });
        // Instantiate first JS Array DataSource
        ...
        this.oAutoComp2.textboxBlurEvent.subscribe(function(){
            if(YAHOO.util.Dom.get('phone').value != "")
            makeRequest('phone', document.getElementById('phone'));
        });
        // Instantiate first JS Array DataSource
        ...
        this.oAutoComp3.minQueryLength = 3;
        ...
        this.oAutoComp3.textboxBlurEvent.subscribe(function(){
            if(YAHOO.util.Dom.get('cell').value != "")
            makeRequest('cell', document.getElementById('cell'));
        });
        // Instantiate first JS Array DataSource
        ...
        this.oAutoComp4.textboxBlurEvent.subscribe(function(){
            if(YAHOO.util.Dom.get('email').value != "")
            makeRequest('email', document.getElementById('email'));
        });
    };
    </script>
