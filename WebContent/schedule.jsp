...
<%!
    int tmw = 90;//TODO for a div target weight
...
<HTML>
	<HEAD>
        ...
        .r{ color:#FFFFFF; background-color: #333333; border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px; border-top-style: solid; border-right-style: solid; border-bottom-style: solid; border-left-style: solid; border-top-color: #2f2e2e; border-right-color: #2f2e2e; border-bottom-color: #2f2e2e; border-left-color: #2f2e2e; }
        ...
        .b1 { font-weight: bold; text-transform: capitalize; color:#B7B7B7; text-indent: 5px; }
        ...
        .STYLE18 {font-family: Arial, Helvetica, sans-serif; font-size: 12px; color:#FFFFFF; font-weight: normal; text-transform: capitalize; text-indent: 5px; text-align: left; }
        .STYLE20 {font-family: Arial, Helvetica, sans-serif; font-size: 11px; color:#FFFFFF; font-weight: normal; text-transform: capitalize; text-indent: 5px; text-align: left; }
        .STYLE21 {background-repeat: repeat-x; color:#FFFFFF; font-size: 11px; border-right-width: 1px; border-right-style: solid; border-right-color: #1A1818; text-align: center; font-family: Arial, Helvetica, sans-serif; font-style: normal; font-weight: normal; text-transform: capitalize; font-variant: normal; }
        .STYLE23 {font-family: Arial, Helvetica, sans-serif; font-size: 12px; color:#FFFFFF; font-weight: bold; text-transform: capitalize; }
        ...
        .player { border:1px solid #bbbbbb; background-color:#333333; color:#eeeeee; text-align:center; position: absolute; width:150px; height:15px; }
    ...
    <table width="1027" border="0" cellpadding="0" cellspacing="0" bgcolor="#000000" height="120">
        ...
        <tr>
            ...
            <td width="140" background="images/schdule_033.gif"><a href="./index.jsp" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image8','','images/schdule_h2.gif',1)"><img src="images/schdule_h1.gif" name="Image8" width="126" height="30" border="0" id="Image8"></a></td>
            <%--User sess_user = (User)session.getAttribute("user"); if(sess_user!=null && sess_user.getPermission()==Role.R_ADMIN){%>
            <td width="120" align="center"><a href="admin/admin.jsp" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image5','','images/ADMIN.gif',1)"><img alt="" src="images/ADMIN red.gif" name="Image5" width="96" height="39" border="0" id="Image5"></a></td>
            <%}--%>
            <td width="139" background="images/schdule_s2.gif">&nbsp;</td>
            <td width="136" background="images/schdule_033.gif"><a href="./checkout.do" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image9','','images/schdule_c2.gif',1)"><img src="images/schdule_c1.gif" name="Image9" width="133" height="30" border="0" id="Image9"></a></td>
            ...
            <td><table border="0" cellpadding="0" cellspacing="0"><!--width="998" -->
                    <tr>
												...
												<tr>
													<td  id="homeTBL" name="homeTBL">
														<div>
															<table>
																<tr>
																	<td width="60" height="9" class="STYLE20">
																		First Name</td>
																	<td class="STYLE18">
															...
															<div id="customerDIV" style="position:absolute;z-index:10">
                                                    ...
                                                    <td align="left"><table border="0" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <tr>
                                                                <td width="150" height="20"><!--<th class="STYLE4" scope="row">-->
                                                                    <table border="0" cellpadding="0" cellspacing="0" style="z-index:100;">
                                                                        <%
                                                                            int min_svc = 15;
                        ...
                        <td align="left" valign="top"><!--width="780" -->
                            <table border="0" cellpadding="0" cellspacing="0" bordercolor="#000000" bgcolor="#000000"><!--width="780" -->
                                <tr>
                                    <td height="630" valign="top" class="bg">
                                        <table height="607" border="0" cellpadding="0" cellspacing="0"><!--width="780" -->
                                            <tr>
                                                ...
                                                <td ><!--height="575"-->
                                                    <table  border="0" align="left" cellpadding="0" cellspacing="0"><!--width="720"-->
                                                        ...
                                                        <tr>
                                                            <td width="5"></td>
                                                            <!--time images-->
                                                            <td width="51" height="<%=60*tmh%>px" background="./images/time_<%=i%>.gif"  valign="top"><%=i%></td>
                                                            <!--appointments-->
                                                            <td valign="top">
                                                                <table id="tb<%=i-1%>" border="0" cellspacing="0" cellpadding="0">
                                                                    <%for(int j = 0; j<60; j+=delta){%>
                                                                    <tr>
                                                                        <%
    ...
    function insert(player, el, oDD){
        try{
            ...
            var cb =
            {
                ...
                argument: { ctrl: el.id }//TODO v.id ? el.id
            };
    ...
    function handleDelete(e){//TODO rightclick, remove appt also
        var evt = e || window.event;
        if(this.player && evt.button==2){
            remove(this.player);
            if(this.player.slot.player.id &  this.player.slot.player.id == this.player.id)
                this.player.slot.player = null;
            else if(this.player.slot.player1)
                this.player.slot.player1 = null;
            this.parentNode.removeChild(this);
        }
    }
    ...
    {
        var evt = e || window.event;
        window.location = "./checkout.jsp?dt=<%=dt%>" + "&emp=" + this.employee_id 
                + "&cust=" + this.customer_id +  "&svc=" + this.service_id + "&appt=" + this.appt_id;
    }
    </script>
        ...
        onDragDrop: function(e, id) {
            ...
            if (oDD.player) {// check if the slot has a player in it already
                if (this.slot) {// check if the dragged player was already in a slot
                    ...
                    //oDD.player.slot = null;
                    //YAHOO.util.DDM.moveToEl(oDD.player.getEl(), el);
                    /*remove(oDD.player);//TODO split time box =>

                    oDD.player.getEl().parentNode.removeChild(oDD.player.getEl());
                    oDD.player.slot = null;
                    oDD.player = null;*/
                    var em = oDD.player.getEl();
                    if(!oDD.player1)
                    {
                        em.style.width = "<%=tmw/2%>px";
                        oDD.player.resizeFrame = true;
                        oDD.player1 = oDD.player;
                    }
                    else
                    {
                        remove(oDD.player1);//note!!!
                        
                        oDD.player1.getEl().parentNode.removeChild(oDD.player1.getEl());
                        oDD.player1.slot = null;
                        oDD.player1 = null;

                        em.style.left = parseInt(em.style.left) - <%=tmw/2%> + "px"; 
                        oDD.player.resizeFrame = true;
                        oDD.player1 = oDD.player;
                    }//<=split time box
                    ...
                    if(!el.tip){
                        ...
                        el.cust_name = document.getElementById("txtFirstName").value + " " + document.getElementById("txtLastName").value;
                        el.tip = new YAHOO.widget.Tooltip("tt_" + el.id, { context:el.id, text:el.cust_name + " :: " + el.svc_name});
                    }

                    YAHOO.util.DDM.moveToEl(el, oDD.getEl());//split time box=>
                    this.resetTargets();
                    this.slot = oDD;
                    this.slot.player = this;

                    el.style.width = "<%=tmw/2%>px";
                    el.style.left = parseInt(em.style.left) + <%=tmw/2%> + "px";
                    divPl.resizeFrame = true;
                    return;//<=split time box
                }
            } else {
            ...
            el.onmouseup = handleDelete;
            el.ondblclick = handleCheckout;
            el.player = this;
            ...
            for(int j=0; al!=null && j<al.size(); j++){
                ...
                if(pl && target){
                    ...
                    if(!target.player){
                        ...
                        var em = target.player.getEl();
                        target.player1 = target.player;
                        em.style.width = "<%=tmw/2%>px";
                        target.player.resizeFrame = true;
