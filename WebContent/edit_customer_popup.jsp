...
<LINK href="css/edit_cust.css" type=text/css rel=stylesheet>
...
<div align="center">
    <div style="width: 901px; height:559px; background: url(img/edit_customer/bgrnd.png) no-repeat;">
        <br />
        <br />
        <table cellspacing="5" cellpadding="0" border="0" style="margin-left: 36px;margin-right: 36px;" width="801">
            <tr>
        ...
        <table width="740" height="432" border="0" cellpadding="0" cellspacing="0">
        <tr>
        <td>
        <div id="container">
        <div class="padder">
        ...
        <%--<form id="customer" name="customer" method="post" action="./customer.do?action=edit"  enctype="multipart/form-data" onsubmit="return formvalidate(this);">--%>
            ...
            <div class="contacts">
                ...
                <table cellspacing="0" cellpadding="0" style="float: left">
                    <tr>
                        ...
                        <%--<td style="margin:0; padding: 0"><input type="button" id="selbdDate" value='' style="background: url(/img/cal.png); width: 22px;height: 22px; border:0;"/></td>--%>
                    </tr></table>
                <%--<SCRIPT type="text/javascript">--%>
                    <%--Calendar.setup(--%>
                            <%--{--%>
                                <%--inputField  : "b_date",     // ID of the input field--%>
                                <%--button      : "selbdDate",  // ID of the button--%>
                                <%--showsTime	: false,--%>
                                <%--electric    : false--%>
                            <%--}--%>
                    <%--);--%>
        ...
        <div style="float: right; margin-right: 20px;">
            <input type="image" src="img/edit_customer/button_save.png" width="86" height="26" onclick="saveCustomer_popup('<%=id%>');">
        </div>
        <%--</form>--%>
