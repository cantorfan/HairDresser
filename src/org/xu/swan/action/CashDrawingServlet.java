...
import org.xu.swan.util.ParseUtil;
...
//            ResourcesManager resx = new ResourcesManager();
            if (user_ses != null){
                ...
                int id = ParseUtil.parseInt(request.getParameter("id"));
                int loc = ParseUtil.parseInt(request.getParameter("loc"));
                int employeeID = ParseUtil.parseInt(request.getParameter("employeeID"));
                Timestamp date = Timestamp.valueOf(request.getParameter("date"));
                int pennies = ParseUtil.parseInt(request.getParameter("pennies"));
                int nickels = ParseUtil.parseInt(request.getParameter("nickels"));
                int dimes = ParseUtil.parseInt(request.getParameter("dimes"));
                int quarters = ParseUtil.parseInt(request.getParameter("quarters"));
                int half_dollars = ParseUtil.parseInt(request.getParameter("half_dollars"));
                int dollars = ParseUtil.parseInt(request.getParameter("dollars"));
                int singles = ParseUtil.parseInt(request.getParameter("singles"));
                int fives = ParseUtil.parseInt(request.getParameter("fives"));
                int tens = ParseUtil.parseInt(request.getParameter("tens"));
                int twenties = ParseUtil.parseInt(request.getParameter("twenties"));
                int fifties = ParseUtil.parseInt(request.getParameter("fifties"));
                int hundreds = ParseUtil.parseInt(request.getParameter("hundreds"));
                int openClose = ParseUtil.parseInt(request.getParameter("openClose"));
